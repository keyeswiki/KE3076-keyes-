...
在microUSB连接器旁边安装了一个板载LED，它内部连接到GPIO针脚25，这是整个树莓派Pico主板上唯一的LED。
开机按钮安装在离LED稍低一点的地方，它可以让你改变树莓派Pico的启动模式，这样你就可以在上面加载MicroPython，进行拖拽式编程。
...
![图片不存在](./media/024e38335dd1d239665cda323eb5e640.png)
...
![图片不存在](./media/22390788ef8b515d41a01486b179c2a7.png)
...
在新的对话框中，选中“Project_09_Steam_Sensor.py”,单击“**打开**”。

![图片不存在](./media/43b2be09ffe84d9fdd9b47414a0952d8.png)
...
| 代码                                 | 说明                                                         |
| ------------------------------------ | ------------------------------------------------------------ |
|PIN_ANALOG_IN = machine.ADC(26)|水滴传感器模块的模拟管脚为GPIO26，也是0通道即ADC(0)。|
|PIN_ANALOG_IN.read_u16()|读取水滴传感器的ADC值，范围为0~65535，那么PIN_ANALOG_IN.read_u16()即读取ADC(26)引脚输入的ADC值，然后赋给名为adcvalue1的变量|
|voltage = adcvalue1 / 65535.0 * 3.3  | 将水滴传感器读取的ADC值转化成电压值。            |
|print()|Shell窗口打印|
...
上一项目中我们已经学习了水滴传感器的工作原理，这一项目中我们将水滴传感器和LED灯组合实验，实现水滴传感器检测水量大小输出的ADC值大于一定值时LED快速闪烁的效果。

2. 项目元件：

|![图片不存在](./media/d12071168fd2fd07dcd66e4a187d91bd.png)|![图片不存在](./media/3eb806e0acb028c1b242da3b85c44e58.png)|![图片不存在](./media/3ee049150a7d8652a0d07b3b451b3346.png)|![图片不存在](./media/28c28e6163de71f861c1f8f9bf621ee2.png)|
| :--: | :--: | :--: |:--: |
...
![图片不存在](./media/3fd81542acffdde21bb5982edce3adc0.png)
...
在新的对话框中，选中“Project_10_Steam_Sensor_Control_LED.py”,单击“**打开**”。

![图片不存在](./media/3e0e378d3fcda2bfa600a699df00a41a.png)

<span style="color: rgb(255, 76, 65);">注意：</span>代码中的阈值50000可以根据实际情况更改的。
...
按照接线图正确接好模块和各元器件，利用MicroUSB线连接到计算机上电，单击![图片不存在](./media/4ac0a5cec03a20e095f56686af2e4c0c.png)来执行程序代码。代码开始执行，你会看到的现象是：外接LED灯不亮，同时Shell窗口中显示ADC值和"LED OFF!"；然后在水滴传感器模块上的感应区滴一两滴水，当水滴传感器检测水量大小输出的ADC值大于50000时，外接LED灯快速闪烁，同时Shell窗口中显示ADC值和"LED Blinking!"。

![图片不存在](./media/3a0270c2573c0309c91bdf877c855d77.jpg)
...
|adcvalue > 50000:|水量大小检测，检测到水量大小的ADC值大于50000。|
| led.value(1)  | LED灯点亮。                      |
|led.value(0) | LED灯熄灭。                      |
...
|![图片不存在](./media/d12071168fd2fd07dcd66e4a187d91bd.png)|![图片不存在](./media/3eb806e0acb028c1b242da3b85c44e58.png)|![图片不存在](./media/3ee049150a7d8652a0d07b3b451b3346.png)|![图片不存在](./media/08cac8e036b616593db2d11a13d7922d.png)|![图片不存在](./media/28c28e6163de71f861c1f8f9bf621ee2.png)|
| :--: | :--: | :--: |:--: |:--: |
...
![图片不存在](./media/b5986917f7ddc5c43e2dea9d1f7124b3.png)
...
在新的对话框中，选中“Project_11_Water_Detection_Alarm_System.py”,单击“**打开**”。

![图片不存在](./media/5f78ffcddd2d571be30353c9f539e9c1.png)
...
按照接线图正确接好模块和各元器件，利用MicroUSB线连接到计算机上电，单击![图片不存在](./media/4ac0a5cec03a20e095f56686af2e4c0c.png)来执行程序代码。代码开始执行，你会看到的现象是：有源蜂鸣器不鸣叫，外接LED灯不亮，同时Shell窗口中显示ADC值和"Buzzer won't sound and led off!"；然后在水滴传感器模块上的感应区滴一两滴水，当水滴传感器检测水量大小输出的ADC值大于50000时，有源蜂鸣器发出警报，外接LED灯快速闪烁，同时Shell窗口中显示ADC值和“Buzzer sounds and led blinking!”。

![图片不存在](./media/2ec5b1c43ce4ff00006ba031db3930ff.jpg)
